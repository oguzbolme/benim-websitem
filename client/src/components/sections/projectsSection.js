                ...
                <div className="row" style={{margin:"10px"}}>
                        ...
                        <div className="card mb-3" style={{maxWidth:"540px",backgroundColor:"#30323D"}}>
                            <div className="row no-gutters">
                                <div className="col-md-4">
                                    <img src={require('../../images/projects/dikilim.png')} alt="dikilim" className="card-img" />
                                </div>
                    ...
                    <div className="col-sm-6">
                        <div className="card mb-3" style={{maxWidth:"540px",backgroundColor:"#30323D"}}>
                            <div className="row no-gutters">
                                <div className="col-md-4">
                                    <img src={require('../../images/projects/smart-library.png')} alt="smart-library" className="card-img" />
                                </div>
                                <div className="col-md-8">
                                    <div className="card-body">
                ...
                <div className="row" style={{margin:"10px"}}>
                    <div className="col-sm-6">
                        <div className="card mb-3" style={{maxWidth:"540px",backgroundColor:"#30323D"}}>
                            <div className="row no-gutters">
                                <div className="col-md-4">
                                    <img src={require('../../images/projects/dictionary.png')} alt="directory" className="card-img" />
                                </div>
                                <div className="col-md-8">
                                    <div className="card-body">
                    ...
                    <div className="col-sm-6">
                        <div className="card mb-3" style={{maxWidth:"540px",backgroundColor:"#30323D"}}>
                            <div className="row no-gutters">
                                <div className="col-md-4">
                                    <img src={require('../../images/projects/machine-learning.png')} alt="ml" className="card-img" />
                                </div>
                                <div className="col-md-8">
                                    <div className="card-body">
